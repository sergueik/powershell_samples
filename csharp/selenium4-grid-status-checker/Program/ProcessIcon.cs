...
namespace SeleniumClient {
	...
	public partial class ProcessIcon : Form {
		...
		public void Display() {
			...
			// https://docs.microsoft.com/en-us/dotnet/api/system.drawing.icon?view=netframework-4.5
            ...
            notifyIcon.BalloonTipTitle = "System 4 Tray Selenium Grid Status Checker";
       ...
       public void DisplayBallonMessage(string message, int delay) {
            if (!string.IsNullOrEmpty(message)) {
				...
				notifyIcon.BalloonTipText = "polls status of Selenium Grid";
            	notifyIcon.BalloonTipTitle = "System Tray Selenium 4 Grid Status Checker";
			}

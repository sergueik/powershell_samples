...
namespace TransactionService {
	public class LoadAverageCounterService : ServiceBase {
		...
		private string eventLogName = "LoadAverageCounterService";
		...
		static void Main() {
			...
			ServicesToRun = new System.ServiceProcess.ServiceBase[] { new LoadAverageCounterService() };
			System.ServiceProcess.ServiceBase.Run(ServicesToRun);
		}

		public LoadAverageCounterService() {
			buffer = new CircularBuffer<Data>(capacity);
			AutoLog = false;

			// TODO: read LoadAverageCounterService.resx <data name="$this.Name"> programmaticallly
			// watch the case

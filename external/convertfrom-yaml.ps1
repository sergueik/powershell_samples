...
# origin: https://www.powershellgallery.com/packages/FXPSYaml/1.0.3/Content/Public%5CConvertFrom-Yaml.ps1
# uses YamlDotNet assembly
# https://www.cyberforum.ru/powershell/thread2802757.html PSCustomObject vs. Class vs. convertFrom-JSON and 
# ConvertFrom-YAML discussion (in Russian)	
# see also: https://github.com/cloudbase/powershell-yaml

#  https://chentiangemalc.wordpress.com/2012/01/17/powershell-script-to-remove-office-macro-protection/
$compilerParameters = New-Object System.CodeDom.Compiler.CompilerParameters
$compilerParameters.CompilerOptions="/unsafe /reference:C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Windows.Forms.dll,C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Data.dll,C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Xml.dll,C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Runtime.InteropServices.dll,C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.dll"


# http://www.codeproject.com/Articles/15288/Parsing-event-log-evt-file
                ...
                using (FileStream fs = new FileStream(filename, FileMode.Open))
                {
                    ...
                    using (BinaryReader br = new BinaryReader(fs))
                    {
                        ...
                        while (true)
                        {
                            ...
                            this.OnFoundRecord(
                                new object[] { 
                                    Enum.GetName(typeof(System.Diagnostics.EventLogEntryType),e.rec.EventType),
...
"@
# -UsingNamespace
#   -ReferencedAssemblies 'System.Windows.Forms.dll','System.Data.dll','System.Xml, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089'
# https://technet.microsoft.com/en-us/library/hh849914.aspx says:
# You cannot use the CompilerParameters and ReferencedAssemblies parameters in the same command.
# -CompilerParameters  '/unsafe'
$o = New-Object -TypeName 'EventLogParser.EventLogParser' 
$o

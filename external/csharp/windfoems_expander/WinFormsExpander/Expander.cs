...
namespace WinFormsExpander {
    ...
    public partial class Expander : UserControl {
        ...
        public int CollapsedHeight { get { return  collapsedHeight ; }  set {collapsedHeight =  value;}}
        
        public int ExpandedHeight { get; private set; }

        [Category("Appearance"), DefaultValue(typeof(int), "25")]
        private int minimumContentHeight = 25;
        public int MinimumContentHeight { 
        	 get { return minimumContentHeight; }
        ...
        public override Size MinimumSize { get {return  _minimumSize;}}
        ...
        public Panel Content(){ return  splitContainer.Panel2;}

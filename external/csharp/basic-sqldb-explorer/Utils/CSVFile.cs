...
// origin: https://github.com/sqldatabase/embedded-dotnetcore20/blob/master/SQLDatabase.Net.Core.Examples/SQLDatabase.Net.Core.Examples/CSVFile.cs
namespace CSVFile
{
	...
	public class CsvImportExport
	{
		...
		public SqlDatabaseTransaction SQLDatabaseTransaction { get; set; }
	...
	public class CsvFileReader : IDisposable
	{
		...
		public bool StoreLineOffSets { get; set; }
		public long StartAtOffSet { get; set; }
		...
		private void InitCsvReader()
		{
			...
			QuoteChar = Convert.ToChar('"');
			CommentLineStartsWith = "";
			SkipLines = 0;
			MaximumLines = -1;
			StoreLineOffSets = false;
		}

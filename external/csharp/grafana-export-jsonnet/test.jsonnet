...
*/
            ...
            .addPanel(
              ...
              panel=grafana.gaugePanel.new(title='Panel 1',pluginVersion='7.3.4',thresholdsMode='absolute',),
/*
              datasource=prometheus
              .addTarget(
                    prometheus.target(
...
*/
            ...
            .addPanel(
              ...
              panel=grafana.gaugePanel.new(title='Panel Title',pluginVersion='7.3.4',thresholdsMode='absolute',),
/*
              datasource=prometheus
              .addTarget(
                    prometheus.target(

# origin: https://github.com/markwragg/PowerShell-Influx/blob/master/Influx/Public/Write-Influx.ps1
# NOTE: the feature script 
# is accomplished with all kind of module install helpers plumbing, totaling to approx 100 files
    ...
    process {
            ...
            if ($Body) {
                ...
                If ($Bulk) {
                    ...
                    if ($PSCmdlet.ShouldProcess($URI, $Body)) {
                        Invoke-RestMethod -Uri $URI -Method Post -Body $Body -Headers $Headers -TimeoutSec $TimeoutSec | Out-Null 
                    }
                }
        ...
        if ($Bulk) {
            ...
            if ($PSCmdlet.ShouldProcess($URI, $BulkBody)) {
                Invoke-RestMethod -Uri $URI -Method Post -Body $BulkBody -Headers $Headers -TimeoutSec $TimeoutSec | Out-Null
            }
        }
    }
}

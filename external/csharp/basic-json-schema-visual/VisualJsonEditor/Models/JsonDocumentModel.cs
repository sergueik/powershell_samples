        ...
        public string FilePath
        {
            ...
            set {
            	if (Set(ref _filePath, value)){ 
						// The best overloaded method match for 'MyToolkit.Model.ObservableObject.RaisePropertyChanged(string)' has some invalid arguments (CS1502)
						// Argument 1: cannot convert from 'System.Func<object>' to 'string' (CS1503)
						// Func<object> hasFileLocationPropertyNameExpression =  () => {	return this.HasFileLocation;};
						// RaisePropertyChanged(hasFileLocationPropertyNameExpression);
                	RaisePropertyChanged("HasFileLocation");
                    // RaisePropertyChanged(() => this.DisplayTitle);

...
namespace Program {
	public partial class Form1 : Form {
		...
		private CircularProgressControl circularProgressControl2;
		...
		private void InitializeComponent() {
			...
			circularProgressControl2 = new CircularProgressControl {
			...
			this.Controls.Add(circularProgressControl2);

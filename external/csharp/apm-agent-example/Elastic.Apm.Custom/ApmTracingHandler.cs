    ...
    public class ApmTracingHandler : DelegatingHandler
    {
        ...
        public static void RecordRequest(HttpRequestMessage httpRequest, ITransaction transaction)
        {
            ...
            transaction.Context.Request = new Request(httpRequest.Method.Method, url)
            {
                Socket = new Socket
                {
                    // TODO: Error   CS0117  'Socket' does not contain a definition for 'Encrypted'  Elastic.Apm.Custom  C:\developer\sergueik\powershell_ui_samples\external\csharp\apm - agent - example\Elastic.Apm.Custom\ApmTracingHandler.cs   59  Active

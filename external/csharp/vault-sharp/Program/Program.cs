...
*/
        ...
        private static void RunSystemBackendSamples()
        {
            ...
            Assert.AreEqual(ExpectedVaultVersion, health.Version);

            Assert.False(health.Initialized);
            Assert.True(health.Sealed);
            Assert.AreEqual((int)HttpStatusCode.NotImplemented, health.HttpStatusCode);
   ...
   //         Assert.AreEqual((int)HttpStatusCode.NotImplemented, headException.StatusCode);
            ...
            Assert.AreEqual(initOptions.SecretShares, masterCredentials.MasterKeys.Length);
            Assert.AreEqual(initOptions.SecretShares, masterCredentials.Base64MasterKeys.Length);
            ...
            Assert.True(health.Sealed);
            Assert.AreEqual((int)HttpStatusCode.ServiceUnavailable, health.HttpStatusCode);

            health = _unauthenticatedVaultClient.V1.System.GetHealthStatusAsync(sealedStatusCode: 404).Result;
            DisplayJson(health);
            Assert.True(health.Initialized);
            Assert.True(health.Sealed);
            Assert.AreEqual((int)HttpStatusCode.NotFound, health.HttpStatusCode);
            ...
            foreach (var masterKey in masterCredentials.MasterKeys)
            {
                ...
                {
                    Assert.AreEqual(threshold, unsealStatus.Progress);
                    ...
                    if (!reset && (threshold == initOptions.SecretThreshold - 2))
                    {
                        ...
                        Assert.AreEqual(0, unsealStatus.Progress);
                        Assert.True(unsealStatus.Sealed);
            ...
            Assert.True(health.Initialized);
            Assert.False(health.Sealed);
            Assert.AreEqual((int)HttpStatusCode.MethodNotAllowed, health.HttpStatusCode);
            ...
            Assert.AreEqual(audits.Data.Count() + 2, newAudits.Data.Count());
            ...
            Assert.AreEqual(audits.Data.Count(), oldAudits.Data.Count());
            ...
            DisplayJson(backendConfig);
            Assert.AreEqual(2764800, backendConfig.Data.DefaultLeaseTtl);
            Assert.AreEqual(2764800, backendConfig.Data.MaximumLeaseTtl);
            ...
            backendConfig = _authenticatedVaultClient.V1.System.GetAuthBackendConfigAsync(newAuth.Path).Result;
            DisplayJson(backendConfig);
            Assert.AreEqual(newBackendConfig.DefaultLeaseTtl, backendConfig.Data.DefaultLeaseTtl);
            Assert.AreEqual(newBackendConfig.MaximumLeaseTtl, backendConfig.Data.MaximumLeaseTtl);

            // raja todo: this is not heeded by vault. look into it.
            // Assert.AreEqual(newBackendConfig.ForceNoCache, backendConfig.Data.ForceNoCache);

            // get all auths
            var newAuthBackends = _authenticatedVaultClient.V1.System.GetAuthBackendsAsync().Result;
            DisplayJson(newAuthBackends);
            Assert.AreEqual(authBackends.Data.Count() + 1, newAuthBackends.Data.Count());
            ...
            Assert.AreEqual(authBackends.Data.Count(), oldAuthBackends.Data.Count());
            ...
            Assert.AreEqual(reqHeaders.Data.Headers.Count + 2, newReqHeaders.Data.Headers.Count);
            ...
            DisplayJson(cgconfig);
            Assert.AreEqual("4h", cgconfig.Data.MaxTimeToLive);
...
// Error CS1503: Argument 2: cannot convert from 'System.Collections.Generic.IEnumerable<string>' to 'System.Collections.ICollection'
            ...
            */
            ...
            DisplayJson(readDuo);
            Assert.AreEqual(duoConfig.MountAccessor, readDuo.Data.MountAccessor);
...
// sk
            ...
            Assert.AreEqual(ttl, newMountConfig.Data.DefaultLeaseTtl);

            // get secret backends
            var newSecretBackends = _authenticatedVaultClient.V1.System.GetSecretBackendsAsync().Result;
            DisplayJson(newSecretBackends);
            Assert.AreEqual(secretBackends.Data.Count() + 1, newSecretBackends.Data.Count());
            ...
            Assert.AreEqual(secretBackends.Data.Count(), oldSecretBackends.Data.Count());
            ...
            newSecretBackends = _authenticatedVaultClient.GetAllMountedSecretBackendsAsync();
            Assert.AreEqual(secretBackends.Data.Count(), newSecretBackends.Data.Count());
            */
            ...
            Assert.AreEqual(plugins.Data.Keys.First(), pluginConfig.Data.Name);
            ...
            // Assert.AreEqual(plugins.Data.Keys.Count - 1, lessPlugins.Data.Keys.Count);
            ...
            DisplayJson(pluginConfig);
            // Assert.AreEqual(newPluginConfig.Command, pluginConfig.Data.Command);
            ...
            Assert.AreEqual(newPolicy.Rules, newPolicyGet.Data.Rules);
            ...
            Assert.AreEqual(newPolicies.Data.Keys.Count(), oldPolicies.Data.Keys.Count() + 1);
            ...
            Assert.AreEqual(newAclPolicy.Policy, newAclPolicyGet.Data.Policy);
            ...
            Assert.AreEqual(newAclPolicies.Data.Keys.Count(), oldAclPolicies.Data.Keys.Count() + 1);
            ...
            DisplayJson(readRawValues1);
            Assert.AreEqual("bar42", readRawValues1.Data["foo"]);
            ...
            Assert.AreEqual(newInitOptions.SecretShares, rekeyProgress.MasterKeys.Length);
            ...
            Assert.True(rekeyStatus.UnsealKeysProvided == 0);
            Assert.AreEqual(string.Empty, rekeyStatus.Nonce);
            ...
            Assert.AreNotEqual(DateTimeOffset.MinValue, tokenWrapInfo.Data.CreationTime);
            ...
            Assert.AreNotEqual(wrappedResponse.WrapInfo.Token, rewrappedResponse.WrapInfo.Token);
            ...
            Assert.AreEqual(data.Count, unwrappedResponse.Data.Count);

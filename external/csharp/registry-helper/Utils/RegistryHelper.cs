...
namespace Utils
{
	public class RegistryHelper
	{
		...
		//this variable contains the error message (null when no error occured)


		public RegistryHelper() //class constructor
		{
		}
		...
		public string GetStringValue(RegistryKey hiveKey, string strSubKey, string strValue)
		{
			...
			try {
				...
				if (subKey == null) {
					strRegError = "Cannot open the specified sub-key: " + strSubKey;
					return null;
				}

...
schtasks.exe /create /tn RunCMD /tr "c:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -executionpolicy bypass -noprofile -f '%1'" /rl HIGHEST /ru %USERNAME% /rp %PASSWORD% /sc once /st %t:~0,8% /sd %d:~4,10% /v1 /z

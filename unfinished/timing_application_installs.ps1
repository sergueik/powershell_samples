...
# origin http://weblogs.asp.net/whaggard/438006


<# 
# https://msdn.microsoft.com/en-us/library/2wkebaxa%28v=vs.100%29.aspx

You need to generate by win32_process classs by running:
"c:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\mgmtclassgen.exe" Win32_Process /n root\cimv2 /o WMI.Win32
#>
...
$o = New-Object WMI.Win32.ProcessWatcher("notepad.exe")
$o.Start()
$o.Stop()
